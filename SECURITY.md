...
The currently published line is 0.2.0-beta.1. The first stable product target is
1.0, without a committed date. A new supported release or minor line requires
an explicit update to this support policy;
